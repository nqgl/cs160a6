...
ClassTable {
  ...
  class1 -> {
    ...
    VariableTable {
      member3 -> {Integer, 0, 4},
      member4 -> {Integer, 4, 4},
      member5 -> {Object(class0), 8, 4},
      member6 -> {Integer, 12, 4}
    },
    MethodTable {
      class1 -> {
        None,
  ...
  class2 -> {
    class1,
    VariableTable {
      member10 -> {Object(class1), 0, 4},
      member7 -> {Boolean, 4, 4},
      member8 -> {Object(class0), 8, 4},
      member9 -> {Integer, 12, 4}
    },
    MethodTable {
      class2 -> {
        None,
